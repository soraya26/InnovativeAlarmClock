...
public class Settings extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		bindPreferenceSummaryToValue(findPreference("pref_settings_time"));
		bindPreferenceSummaryToValue(findPreference("pref_default_ringtone"));
